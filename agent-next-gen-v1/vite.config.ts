...
export default defineConfig({
  ...
  // https://<your-github-username>.github.io/db-newoutbound-test/, a subpath,
  // not the domain root — so built asset URLs need this prefix or they 404.
  // If your GitHub username isn't the one already used elsewhere in this
  // repo, no change needed here — this path only depends on the repo name.
  base: "/db-newoutbound-test/",
  plugins: [react()],
  resolve: {
    alias: {
